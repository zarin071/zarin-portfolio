...
export const chatConfig: ChatEntry[] = [
  // ─── GENERAL ───────────────────────────────────────────────
  {
    ...
    category: "General",
    answer:
      "Hi! I'm Zarin. I'm a design-engineer hybrid with 10+ years of experience spanning UX design, front-end development, and AI product design. I've worked across global B2B and B2C platforms at bp, Michelin, Packt Publishing, and TCS. Currently, I'm a Senior Product Designer and Capability Lead at bp, driving design maturity across India and global hubs. I'm also a food historian (ask me about wasabi and sushi!), a BJJ learner, and someone who genuinely believes the best products come from the intersection of research, code, and empathy.",
  },
  {
    id: "resume",

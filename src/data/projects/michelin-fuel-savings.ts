...
const michelinFuelSavings: Project = {
  ...
  // The core tension + the research approach that de-risks each axis, surfaced
  // under the "Discovery" section.
  discovery: {
    summary:
      "The real difficulty wasn't visual — it was a three-way tension that pulled against itself: Trust vs. Friction vs. Conversion, all on an enterprise design system with no motion vocabulary. Every decision had to serve all three at once — lowering friction couldn't cost accuracy; capturing a lead couldn't cost trust. So before committing to the interaction model, I scoped the research to de-risk each axis: qualitative discovery with the people on both sides of the sale, evaluative testing of the riskiest design bets, and analytics to validate the model once it was live.",
    questions: [

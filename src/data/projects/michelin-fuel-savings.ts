...
const michelinFuelSavings: Project = {
  ...
  // The core design tension, surfaced under the "Discovery" section.
  discovery: {
    summary:
      "The real difficulty wasn't visual — it was a three-way tension that pulled against itself: Trust vs. Friction vs. Conversion. Every decision had to serve all three at once. Lowering friction couldn't cost accuracy; capturing a lead couldn't cost trust. Resolving that tension through interaction design — rather than compromising on any one axis — became the whole brief.",
    questions: [
      "Trust — why would a skeptical fleet owner believe a number generated by the very company trying to sell to them?",
      "Friction — fleet operators aren't tyre engineers. Ask for technical detail (dimensions, consumption data) and completion dies; ask for too little and the result feels generic and untrustworthy.",
      "Conversion — marketing needed a lead, but a form-first, gated experience would scare people off before they saw any value.",
      "Engineering — the enterprise design system was built around fixed, static imagery with no motion vocabulary, yet the most important moment (the savings reveal) needed to feel alive. Adding animation on top of a system that wasn't designed for it, without breaking its visual language.",
    ],
  },
